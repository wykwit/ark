...
int scan_init(void)
{
	...
	if (_kallsyms_lookup_name == 0)
		return -ELIBACC;
#else
	_kallsyms_lookup_name = (unsigned long (*)(const char *)) &kallsyms_lookup_name;
#endif
...
struct file_operations proc_period_fops = {
	.owner = THIS_MODULE,
	.write = proc_period_write,
};
#endif
